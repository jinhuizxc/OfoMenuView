...
public class OfoContentLayout extends LinearLayout {
    ...
    public OfoContentLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public OfoContentLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
